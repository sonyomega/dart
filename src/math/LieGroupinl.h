...
//inline Vec3 AdInvTLinear(const SE3& T, const Vec3& v)
//{
//    return Vec3(T(0,0)*v[0] + T(1,0)*v[1] + T(2,0)*v[2],
//                T(0,1)*v[0] + T(1,1)*v[1] + T(2,1)*v[2],
//                T(0,2)*v[0] + T(1,2)*v[1] + T(2,2)*v[2]);
...
//inline Vec3 ad_Vec3_se3(const Vec3& s1, const se3& s2)
//{
//    Vec3 ret;
...
//inline se3 AdP(const Vec3& p, const se3& s)
//{
//    //--------------------------------------------------------------------------
//    // w' = w
//    // v' = p x w + v
...
//inline Jacobian AdRJac(const SE3& T, const Jacobian& J)
//{
...
//inline se3 AdInvR(const SE3& T, const se3& s)
//{
//    se3 ret;
...
//inline dse3 dAdTLinear(const SE3& T, const Vec3& v)
//{
//    dse3 ret;
...
//inline SE3 ExpAngular(const Axis& S, double theta)
//{
//    SE3 ret = SE3::Identity();
//    double s2[] = { S[0]*S[0], S[1]*S[1], S[2]*S[2] };
...
//inline Axis AdInvTAngular(const SE3& T, const Axis& v)
//{
