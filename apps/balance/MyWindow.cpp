...
{
    static_cast<BodyNode*>(mWorld->getSkeleton(1)->findBodyNode("fullbody1_h_spine"))->addExtForce(Vector3d(0.0, 0.0, 0.0), mForce);
...
void MyWindow::drawSkels()
{
    ...
    // draw arrow
    if (mImpulseDuration > 0) {
        Vector3d poa = xformHom(mWorld->getSkeleton(1)->findBodyNode("fullbody1_h_spine")->getWorldTransform(), Vector3d(0.0, 0.0, 0.0));
