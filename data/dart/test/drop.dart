...
<dart version="1.0">
    <world name="world 1">
        ...
        <skeleton name="box skeleton">
            <body name="box">
                <gravity>1</gravity>
                <transformation>1 2 3 -0.3 0.2 0</transformation>
                <inertia>
                    <mass>1</mass>
                    <offset>0 0 0</offset>
                    <moment_of_inertia>
        ...
        <skeleton name="skeleton_2">
            <body name="link_1">
                <gravity>1</gravity>
                <transformation>0 0 0 0.5 -0.1 0</transformation>
                <inertia>
                    <mass>1</mass>
                    <offset>0 0 0</offset>
                    <moment_of_inertia>
        ...
        <skeleton name="skeleton_3">
            <body name="link_1">
                <gravity>1</gravity>
                <transformation>0 0 0 0.5 0.2 0</transformation>
                <inertia>
                    <mass>1</mass>
                    <offset>0 0 0</offset>
                    <moment_of_inertia>
        ...
        <skeleton name="skeleton_3">
            <body name="link_1">
                <gravity>1</gravity>
                <transformation>3 2 1 0.0 0.0 0</transformation>
                <inertia>
                    <mass>1</mass>
                    <offset>0 0 0</offset>
                    <moment_of_inertia>
